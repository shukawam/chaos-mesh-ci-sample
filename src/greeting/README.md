...
```
docker build -t greeting-jri -f Dockerfile.jlink .
```

Start the application:

```
docker run --rm -p 8080:8080 greeting-jri:latest
```

See the start script help:

```
docker run --rm greeting-jri:latest --help
```
